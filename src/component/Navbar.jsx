    ...
    <>
      ...
      <div className="flex justify-between items-center px-6">
        ...
        <div className="flex gap-[20px]">
            <div className="flex flex-col w-[191px] h-auto text-[12px] leading-[18px] px-2 py-1 bg-gray-100 items-start rounded-md  shadow-sm">
              <h4 className="text-[#9a9da6]  font-semibold">
                LIVE ACCOUNT
              </h4>
              <p className="text-black font-bold">{balance} ETH</p>
            </div>
